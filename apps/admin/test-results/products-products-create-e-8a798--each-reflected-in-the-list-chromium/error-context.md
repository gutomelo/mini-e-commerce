...
- Name: products.spec.ts >> products: create, edit, soft-delete >> create a product, edit it, soft-delete it, each reflected in the list
- Location: e2e/products.spec.ts:7:7

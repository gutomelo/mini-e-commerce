...
- Name: categories.spec.ts >> categories: delete blocked while products exist >> deleting a category that still has products shows the API's 409 message
- Location: e2e/categories.spec.ts:7:7

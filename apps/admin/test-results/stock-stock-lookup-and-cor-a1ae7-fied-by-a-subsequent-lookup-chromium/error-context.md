...
- Name: stock.spec.ts >> stock: lookup and correction via the real apps/inventory instance >> look up a product's stock quantity and correct it via the UI, verified by a subsequent lookup
- Location: e2e/stock.spec.ts:6:7

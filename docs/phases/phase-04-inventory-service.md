...
- [x] Update `apps/inventory/README.md` (endpoints, env vars, migration/seed workflow, the fake-vs-real `EventPublisher` distinction) and the root README service table if needed (owner: main)
